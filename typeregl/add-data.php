...
if(isset($_POST['btn-save'])){ // test sur le bouton. 
	$codetypereg  = $_POST['CODETYPEREG']; // affectation des valeur evoier par la method post.
	$libelletypereg = $_POST['LIBELLETYPEREG'];
	if($crud->create($codetypereg ,$libelletypereg)){ // test sur l'execution du requete, 
...
<div class="container">
    ...
    <table class='table table-bordered'>
        <tr>
            <td>Code type reglemenent</td><td><input type='text' name='CODETYPEREG' class='form-control' required></td>
        </tr>
        <tr>
            <td>Libelle type logement</td><td><input type='text' name='LIBELLETYPEREG' class='form-control' required></td>
        </tr>
        <tr>
            <td colspan="2">
            ...
            <a href="index_tpregl.php" class="btn btn-large btn-success" style="float: right;">
